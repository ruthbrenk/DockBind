...
TS_df.to_csv('../data/full_BindingMOAD_BindingDB_Tanimoto_similarity_2.csv', index=False)

ch_selected_for_docking = TS_df[TS_df.Tanimoto_Similarity >= 0.7].reset_index(drop=True)
ch_selected_for_docking.to_csv('../data/BindingDB_ligands_selected_for_docking_2.csv', index=False)
